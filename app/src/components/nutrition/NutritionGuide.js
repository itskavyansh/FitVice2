          ...
          <CardContent>
            ...
            <Box sx={{ mb: 2 }}>
              ...
              <Grid container spacing={1}>
                ...
                <Grid item>
                  <Chip label={`${recipe.nutritionInfo.protein} protein`} size="small" />
                </Grid>
                <Grid item>
                  <Chip label={`${recipe.nutritionInfo.carbs} carbs`} size="small" />
                </Grid>
                <Grid item>
                  <Chip label={`${recipe.nutritionInfo.fat} fat`} size="small" />
                </Grid>
              </Grid>
            </Box>
            <Typography variant="subtitle2" gutterBottom>
